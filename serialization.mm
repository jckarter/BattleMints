...
static const boost::array<thing_reader_pair, 28> _thing_reader_pairs = {
    ...
    thing_reader_pair("color_switch",     &thing::from_bin<color_switch>),
    thing_reader_pair("color_door",       &thing::from_bin<color_door>)
};
